...
const paths = {
  ...
  // --- 브랜드 -----------------------------------------------------------
  /* 카카오톡 말풍선. 브랜드 마크라 다른 아이콘과 달리 stroke 가 아닌 fill 이고,
     원본 36x36 좌표를 24 뷰박스 가운데에 맞추려고 transform 을 걸어 두었다. */
  kakao: (
    <path
      fill="currentColor"
      stroke="none"
      transform="translate(-4.35 -4.33) scale(0.907)"
      d="M18.0204 8C11.934 8 7 11.8254 7 16.5442C7 19.595 9.06272 22.2719 12.1656 23.7835C11.9968 24.356 11.0808 27.4663 11.0444 27.7106C11.0444 27.7106 11.0224 27.8942 11.1434 27.9642C11.2643 28.0343 11.4065 27.9799 11.4065 27.9799C11.7532 27.9322 15.4271 25.3947 16.063 24.954C16.6983 25.0424 17.3524 25.0884 18.0204 25.0884C24.1067 25.0884 29.0408 21.2631 29.0408 16.5442C29.0408 11.8254 24.1067 8 18.0204 8Z"
    />
  ),
