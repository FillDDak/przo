...
VALUES (
                ...
                'customer1@email.com',
                '1234',
                '해충 방제 서비스 문의드립니다 (비밀번호: 1234)',
                '안녕하세요. 저희 식당에 해충 방제 서비스를 받고 싶습니다. 견적 문의 부탁드립니다.',
                'pending'
        );
INSERT INTO INQUIRIES (
                INQUIRY_ID,
...
VALUES (
                ...
                'customer2@email.com',
                '1234',
                '정기 방역 서비스 계약 문의 (비밀번호: 1234)',
                '매월 정기적으로 방역 서비스를 받고 싶습니다. 가격과 일정 안내 부탁드립니다.',
                'completed',
                '월 1회 정기 방역 계약 완료. 매월 첫째 주 월요일 오전 방문 예정.',
                SYSTIMESTAMP
        );
-- 시공 사진 예시 데이터
...
VALUES (
                ...
                '/uploads/reviews/바퀴작업.jpg'
        );
INSERT INTO REVIEWS (REVIEW_ID, TITLE, CONTENT, THUMBNAIL)
VALUES (
                SEQ_REVIEW_ID.NEXTVAL,
                '인천시 xx가게 방역',
                '인천시 xx가게 방역을 실시하였습니다. 인천시 xx가게 방역을 실시하였습니다.',
                '/uploads/reviews/약국소독1.jpg'
        );
INSERT INTO REVIEWS (REVIEW_ID, TITLE, CONTENT, THUMBNAIL)
VALUES (
                SEQ_REVIEW_ID.NEXTVAL,
                '부산시 yy식당 방역',
                '부산시 yy식당 해충 방제 서비스를 완료했습니다.',
                '/uploads/reviews/일신소독-1.jpg'
        );
INSERT INTO REVIEWS (REVIEW_ID, TITLE, CONTENT, THUMBNAIL)
VALUES (
                SEQ_REVIEW_ID.NEXTVAL,
                '대구시 zz카페 방역',
                '대구시 zz카페 정기 방역을 진행했습니다.',
                '/uploads/reviews/내시경-1.jpg'
        );
INSERT INTO REVIEWS (REVIEW_ID, TITLE, CONTENT, THUMBNAIL)
VALUES (
                SEQ_REVIEW_ID.NEXTVAL,
                '수원시 ww마트 방역',
                '수원시 ww마트 해충 퇴치 서비스를 완료했습니다.',
                NULL
        );
COMMIT;
-- ============================================
